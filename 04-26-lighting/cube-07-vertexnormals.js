...
//   X    Y    Z    R    G    B
    -.5, -.5, 0.5, 0.0, 0.0, 1.0, // front
    0.5, -.5, 0.5, 0.0, 0.0, 1.0,
    -.5, 0.5, 0.5, 0.0, 0.0, 1.0,
    0.5, 0.5, 0.5, 0.0, 0.0, 1.0,
    0.5, -.5, -.5, 0.0, 0.0, -1., // back
    -.5, -.5, -.5, 0.0, 0.0, -1.,
    0.5, 0.5, -.5, 0.0, 0.0, -1.,
    -.5, 0.5, -.5, 0.0, 0.0, -1.,
    -.5, -.5, -.5, 0.0, -1., 0.0, // bottom
    0.5, -.5, -.5, 0.0, -1., 0.0,
    -.5, -.5, 0.5, 0.0, -1., 0.0,
    0.5, -.5, 0.5, 0.0, -1., 0.0,
    -.5, 0.5, 0.5, 0.0, 1.0, 0.0, // top
    0.5, 0.5, 0.5, 0.0, 1.0, 0.0,
    -.5, 0.5, -.5, 0.0, 1.0, 0.0,
    0.5, 0.5, -.5, 0.0, 1.0, 0.0,
    0.5, -.5, 0.5, 1.0, 0.0, 0.0, // left
    0.5, -.5, -.5, 1.0, 0.0, 0.0,
    0.5, 0.5, 0.5, 1.0, 0.0, 0.0,
    0.5, 0.5, -.5, 1.0, 0.0, 0.0,
    -.5, -.5, -.5, -1., 0.0, 0.0, // right
    -.5, -.5, 0.5, -1., 0.0, 0.0,
    -.5, 0.5, -.5, -1., 0.0, 0.0,
    -.5, 0.5, 0.5, -1., 0.0, 0.0,
]);
