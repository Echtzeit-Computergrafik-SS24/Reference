...
function myRenderLoop(time)
{
    ...
    { // Draw the skybox
        ...
        // Vertex Attributes
        gl.disableVertexAttribArray(earthPositionAttribute);
        gl.disableVertexAttribArray(earthNormalAttribute);
        gl.disableVertexAttribArray(earthTexCoordAttribute);
        gl.enableVertexAttribArray(skyboxPositionAttribute);
        gl.vertexAttribPointer(
            skyboxPositionAttribute, // We want to define the 'a_pos' attribute
            3,               // It has three components (x, y, z)
