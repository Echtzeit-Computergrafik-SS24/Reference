//!
//! This code snippet demonstrates how to define a second attribute
//! for a vertex array buffer object.
//!
...
const vertexPositions = new Float32Array([
    ...
    +.8, -.8, 0.0, 1.0, 0.0, // bottom right
    -.8, +.8, 0.0, 0.0, 1.0, // top left
    +.8, +.8, 1.0, 1.0, 0.0, // top right
]);
